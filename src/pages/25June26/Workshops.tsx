...
const pageKind = "Workshop";
const storageKey = "terramatrix_workshops";
const defaultTitle = "Workshops";
const defaultEyebrow = "WORKSHOPS";
const defaultSummary = "Practice-oriented workshops designed around tools, field workflows, engineering documentation and project-based learning.";
...
export default function Workshops() {
  ...
  const categories = useMemo(
    () => buildCategoryOptions(events.map((item) => item.category), "workshops"),
    [events]
  );
  ...
  const saveRegistration = () => {
    ...
    setForm(emptyForm);
    alert(`${pageKind} registration interest submitted.`);
  };
  ...
  return (
    <main>
      ...
      <section style={toolbar}>
        <input
          type="text"
          placeholder="Search by workshop, category or theme..."
          value={searchText}
        ...
        <div style={modalBackdrop}>
          <div style={modalCard}>
            ...
            <p style={modalSubText}>
              Submit your interest using the same email and phone you will use for
...
const heroSection: CSSProperties = { maxWidth: "1220px", margin: "0 auto", padding: "58px 48px 28px", display: "grid", gridTemplateColumns: "1fr 280px", gap: "28px", alignItems: "center" };
...
const summaryCards: CSSProperties = { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", alignItems: "stretch" };
const summaryCard: CSSProperties = { background: "#DDE9E2", border: "1px solid #C8DBD1", borderRadius: "14px", minHeight: "64px", display: "grid", placeItems: "center", alignContent: "center", gap: "3px", textAlign: "center", color: "#173F35", fontWeight: 900, padding: "9px 10px", boxShadow: "0 8px 18px rgba(23,63,53,0.05)" };
const toolbar: CSSProperties = { maxWidth: "1220px", margin: "0 auto", padding: "16px 48px 22px", display: "grid", gridTemplateColumns: "1fr 260px", gap: "16px" };
...
const eventGrid: CSSProperties = { display: "grid", gap: "20px" };
...
const tagRow: CSSProperties = { display: "flex", gap: "8px", flexWrap: "wrap", alignItems: "center" };
const categoryBadge: CSSProperties = { background: "#F0E6CF", color: "#173F35", borderRadius: "999px", padding: "7px 10px", fontSize: "12px", fontWeight: 900 };
const levelBadge: CSSProperties = { ...categoryBadge, background: "#E7F0EA" };
const cardTitle: CSSProperties = { color: "#173F35", margin: 0, fontSize: "26px", lineHeight: "1.18" };
const cardText: CSSProperties = { color: "#53665E", lineHeight: "1.5", margin: 0, textAlign: "justify" };

...
export default function CourseDetail() {
  ...
  const submitEnquiry = () => {
    ...
    const existing = localStorage.getItem("terramatrix_event_registrations");
    ...
    const newRegistration = {
      ...
      theme: course.level || course.mode || "Course",
      date: course.startDate,
      time: "",
      mode: course.mode,
      certification: normalizeCertification(course.certificate),
      paymentOption: enquiryForm.paymentOption,
      paymentStatus:
        enquiryForm.paymentOption === "Not Applicable / Free" ? "Not Applicable" : "Pending",
      paymentReference: enquiryForm.paymentReference.trim(),
      paymentNote: enquiryForm.paymentNote.trim(),
    ...
    setEnquiryErrors({});
    alert("Registration submitted. The admin team will follow up with confirmation and payment details.");
  };
    ...
    <main>
      ...
      <section style={contentLayout}>
        ...
        <aside style={sidePanel}>
          ...
          <button onClick={() => setShowEnquiry(true)} style={sideButton}>Register</button>
        </aside>
      </section>
          ...
          <div style={modal}>
            ...
            <div style={formGrid}>
              <Field label="Payment Option">
                <select value={enquiryForm.paymentOption} onChange={(e) => setEnquiryForm({ ...enquiryForm, paymentOption: e.target.value })} style={inputStyle}>
              ...
              <Field label="Payment / Transaction Reference">
                <input value={enquiryForm.paymentReference} onChange={(e) => setEnquiryForm({ ...enquiryForm, paymentReference: e.target.value })} style={inputStyle} placeholder="Optional reference number" />
              </Field>
            </div>

            <Field label="Payment Note">
              <textarea value={enquiryForm.paymentNote} onChange={(e) => setEnquiryForm({ ...enquiryForm, paymentNote: e.target.value })} style={textareaStyle} placeholder="Optional payment note" />
            </Field>

            <button onClick={submitEnquiry} style={sideButton}>Submit</button>
          </div>
        </div>
      )}
    </main>

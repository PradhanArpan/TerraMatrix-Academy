...
export default function StudentDashboard() {
  ...
  const categories = useMemo(
    () => getCategoryFilterOptions(courses.map((course) => course.category)),
    [courses]
  );
    ...
    () =>
      getThemeFilterOptions(
        ...
        courses
          ...
          .map((course) => course.theme)
      ),
    [courses, selectedCategory]
  );

  const levels = useMemo(
    () => getLevelFilterOptions(courses.map((course) => course.level)),
    [courses]
  );
  ...
  const filteredCourses = courses.filter((course) => {
    ...
    const matchesSearch =
      ...
      (course.theme || "").toLowerCase().includes(search) ||
    ...
    return matchesSearch && matchesCategory && matchesTheme && matchesLevel;
  });
                  ...
                  <div style={courseBody}>
                    <div style={courseTop}>
                      <div style={badgeRow}>
                        ...
                        <span style={levelBadge}>{course.theme}</span>
